locals {
  functions = {
    ...
    create_shipment = {
      zip     = var.function_zips.create_shipment
      handler = "app.functions.create_shipment.src.app.handler"
    }
    
    update_shipment = {
      zip     = var.function_zips.update_shipment
      handler = "app.functions.update_shipment.src.app.handler"
    }
  }
}
