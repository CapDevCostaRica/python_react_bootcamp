...
Revision ID: 75d6705c8a7a
Revises: 8f753d70f5c8
Create Date: 2025-09-03 06:45:58.977878
...
revision: str = '75d6705c8a7a'
down_revision: Union[str, Sequence[str], None] = '8f753d70f5c8'
...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_family_relation_person_relation_name', 'danielmadriz_family_relation', ['person_id', 'relation', 'name'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('uq_family_relation_person_relation_name', 'danielmadriz_family_relation', type_='unique')
