...
from app.people_extras import get_sushi_ramen_count, get_avg_weight_above_70_by_hair_color, get_most_common_food_overall, get_avg_weight_by_nationality_hair_color
