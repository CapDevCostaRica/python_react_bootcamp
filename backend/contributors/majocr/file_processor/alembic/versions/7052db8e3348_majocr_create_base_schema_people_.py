"""majocr: create base schema people + associations

Revision ID: 7052db8e3348
Revises: 
Create Date: 2025-08-28 17:14:33.682118
...
def upgrade() -> None:
    ...
    op.create_table('food_majocr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    op.create_table('hobby_majocr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    op.create_table('people_majocr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    op.create_table('family_majocr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('person_id', sa.Integer(), nullable=False),
    sa.Column('relation', sa.String(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['person_id'], ['people_majocr.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('person_food_association_majocr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('person_id', sa.Integer(), nullable=False),
    sa.Column('food_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['food_id'], ['food_majocr.id'], ),
    sa.ForeignKeyConstraint(['person_id'], ['people_majocr.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('person_hobby_association_majocr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('person_id', sa.Integer(), nullable=False),
    sa.Column('hobby_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['hobby_id'], ['hobby_majocr.id'], ),
    sa.ForeignKeyConstraint(['person_id'], ['people_majocr.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('study_majocr',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('person_id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('study_majocr')
    op.drop_table('person_hobby_association_majocr')
    op.drop_table('person_food_association_majocr')
    op.drop_table('family_majocr')
    op.drop_table('people_majocr')
    op.drop_table('hobby_majocr')
    op.drop_table('food_majocr')
    # ### end Alembic commands ###
