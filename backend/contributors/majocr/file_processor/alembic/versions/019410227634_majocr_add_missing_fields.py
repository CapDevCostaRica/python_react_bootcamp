"""majocr: add missing fields.

Revision ID: 019410227634
Revises: 7052db8e3348
Create Date: 2025-08-29 11:17:31.061947
...
revision: str = '019410227634'
down_revision: Union[str, Sequence[str], None] = '7052db8e3348'
...
def upgrade() -> None:
    ...
    op.add_column('people_majocr', sa.Column('height_cm', sa.Float(), nullable=False))
    op.add_column('people_majocr', sa.Column('weight_kg', sa.Float(), nullable=False))
    op.add_column('people_majocr', sa.Column('nationality', sa.String(), nullable=False))
    op.alter_column('people_majocr', 'age',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('people_majocr', 'eye_color',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.alter_column('people_majocr', 'hair_color',
               existing_type=sa.VARCHAR(),
               nullable=False)
    op.drop_column('people_majocr', 'gender')
    op.drop_column('people_majocr', 'height')
    op.drop_column('people_majocr', 'weight')
    op.alter_column('study_majocr', 'degree',
               existing_type=sa.VARCHAR(),
               nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column('study_majocr', 'degree',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.add_column('people_majocr', sa.Column('weight', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('people_majocr', sa.Column('height', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('people_majocr', sa.Column('gender', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.alter_column('people_majocr', 'hair_color',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.alter_column('people_majocr', 'eye_color',
    ...
    op.alter_column('people_majocr', 'age',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.drop_column('people_majocr', 'nationality')
    op.drop_column('people_majocr', 'weight_kg')
    op.drop_column('people_majocr', 'height_cm')
