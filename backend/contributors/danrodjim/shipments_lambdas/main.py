...
try:
    from app.functions.shipment.shipment_list.src.app import handler as list_shipments_handler
...
try:
    from app.functions.shipment.shipment_create.src.app import handler as create_shipment
except ImportError:
    create_shipment = no_function_defined

try:
    from app.functions.shipment.shipment_update.src.app import handler as update_shipment
except ImportError:
